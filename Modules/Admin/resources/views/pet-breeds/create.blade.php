                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pet_subcategory_id" id="pet_subcategory_id" class="form-select @error('pet_subcategory_id') is-invalid @enderror">
                                        ...
                                        @foreach($petSubcategories as $subcategory)
                                            <option value="{{ $subcategory->id }}" {{ old('pet_subcategory_id') == $subcategory->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="typical_weight_min" id="typical_weight_min" class="form-control @error('typical_weight_min') is-invalid @enderror" value="{{ old('typical_weight_min') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="typical_weight_max" id="typical_weight_max" class="form-control @error('typical_weight_max') is-invalid @enderror" value="{{ old('typical_weight_max') }}" required>
