        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Pet Subcategory</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pet-subcategories.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pet_category_id" id="pet_category_id" class="form-select @error('pet_category_id') is-invalid @enderror">
                                        ...
                                        @foreach($petCategories as $category)
                                            <option value="{{ $category->id }}" {{ old('pet_category_id') == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description"
                                              ...
                                              rows="4" placeholder="Enter subcategory description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Subcategory
                            </button>
                        </div>
                    </form>
                </div>
