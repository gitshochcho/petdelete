...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.pets.update', $pet) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subcategory_id" id="subcategory_id" class="form-select @error('subcategory_id') is-invalid @enderror">
                                        ...
                                        @foreach($petSubcategories as $subcategory)
                                            <option value="{{ $subcategory->id }}" {{ old('subcategory_id', $pet->subcategory_id) == $subcategory->id ? 'selected' : '' }}>
                                                {{ $subcategory->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="birthday" id="birthday" class="form-control @error('birthday') is-invalid @enderror" value="{{ old('birthday', $pet->birthday?->format('Y-m-d')) }}" required>
                                    @error('birthday')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="weight" id="weight" class="form-control @error('weight') is-invalid @enderror" value="{{ old('weight', $pet->weight) }}" required>
                                    @error('weight')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="current_medications" id="current_medications" rows="3" class="form-control @error('current_medications') is-invalid @enderror">{{ old('current_medications', $pet->current_medications) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="medication_allergies" id="medication_allergies" rows="3" class="form-control @error('medication_allergies') is-invalid @enderror">{{ old('medication_allergies', $pet->medication_allergies) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="health_conditions" id="health_conditions" rows="3" class="form-control @error('health_conditions') is-invalid @enderror">{{ old('health_conditions', $pet->health_conditions) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="special_notes" id="special_notes" rows="3" class="form-control @error('special_notes') is-invalid @enderror">{{ old('special_notes', $pet->special_notes) }}</textarea>
                                    @error('special_notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                <option value="1" {{ old('status', $pet->status) == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $pet->status) == '0' ? 'selected' : '' }}>Disabled</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
