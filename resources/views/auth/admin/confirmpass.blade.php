...
<head>
    ...
    <title>Petbd | Confirm Password</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Petbd | Confirm Password">
    <meta name="author" content="ColorlibHQ">
    <meta name="description" content="Petbd is a Free Bootstrap 5 Admin Dashboard, 30 example pages using Vanilla JS.">
    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header"> 
                <a href="{{ route('adminLogin') }}" class="link-dark text-center link-offset-2 link-opacity-100 link-opacity-50-hover">
